...
const brands: Brand[] = [
  { id: "b-1", name: "McCain", slug: "mccain", products: ["French Fries (6mm, 9mm, 11mm)", "Smiles", "Cheese Shots", "Aloo Tikki", "Potato Cheese Shots"] },
  { id: "b-2", name: "Food Coast", slug: "food-coast", products: ["Frozen Parotas", "Ready-to-Cook Snacks", "Frozen Vegetables"] },
